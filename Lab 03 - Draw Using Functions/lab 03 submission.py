...
def draw_anti_moon(x, y):
    arcade.draw_ellipse_filled(x + 800, 700 + y, 200, 300, arcade.color.BLACK)
...
def draw_all_seeing_eye(x, y):
    arcade.draw_ellipse_filled(x + 600, 400 + y, 250, 100, arcade.color.BLACK, 1)
    arcade.draw_ellipse_filled(x + 610, 400 + y, 150, 50, arcade.color.WHITE, 1)
    arcade.draw_circle_filled(x + 610, 400 + y, 20, arcade.color.RED)
...
def on_draw(delta_time):
    ...
    draw_moon(150,600)
    draw_anti_stuff()
    draw_anti_moon(on_draw.anti_moon, 20)
    draw_anti_moon(400, 400)
    draw_ohio()
    draw_all_seeing_eye(on_draw.all_seeing_eye, 20)
    draw_cloud(150,600)
    ...
    on_draw.sun += -0.5
    on_draw.moon += 1.5
    on_draw.anti_moon += -10
    on_draw.all_seeing_eye += 0.5
    on_draw.all_seeing_eye += 0.5

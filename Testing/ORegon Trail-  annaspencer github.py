...
checkpoints = iter(
    [" Chimney Rock", " Fort Laramie", " Independence Rock", " Soda Springs", " The Dalles", "Oregon City!"])
...
def game_path(supply):
    ...
    # aliens
        ...
        if supply == "A":
            ...
            mod_band_choice = input(
                "You can try to 1.) pay off the Aliens or 2.) Ask if they accept a trade of your supplies. Type 1 or 2 for your choice.")
    ...
    # bandits
        ...
        if supply == "A":
            ...
            mod_band_choice = input(
                "You can try to 1.) pay off the Bandits or 2.) Ask if they accept a trade of your supplies. Type 1 or 2 for your choice.")
            if mod_band_choice == "1":
                time_space()
                print("It worked!")
                continue_path(supply)
...
def first_aid():
    print(
        "Luckily, you have a First Aid Kit and can treat this ailment. Your health is restored! You may continue on the trail....")
    time_space()
...
def no_first_aid():
    print(
        "Unfortunately, you did not purchase a First Aid Kit with your supplies. You will have to wait to see if your health will be restored!")
    time_space()
...
def no_money():
    time_space()
    print(
        "They are demanding money, but you do not have any left after buying supplies. Instead, you hope they will accept some of your vaulable belongings.")
    time_space()
